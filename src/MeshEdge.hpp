...
// ----------------------------------------------------------
	// --- Geodesics In Heat public methods ---
	/** summing cotans of angles opposite for a edge */
	double sumCotans() const;
	
	/** summing areas of faces neighbouring an edge */
	double sumAreas() const;

    /** returning the length of edge */
